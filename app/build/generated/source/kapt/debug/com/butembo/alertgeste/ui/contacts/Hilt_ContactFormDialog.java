...
public abstract class Hilt_ContactFormDialog extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ContactFormDialog() {
    super();
  }

  Hilt_ContactFormDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ContactFormDialog_GeneratedInjector) this.generatedComponent()).injectContactFormDialog(UnsafeCasts.<ContactFormDialog>unsafeCast(this));
    }
  }
