...
public abstract class Hilt_GestureFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GestureFragment() {
    super();
  }

  Hilt_GestureFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GestureFragment_GeneratedInjector) this.generatedComponent()).injectGestureFragment(UnsafeCasts.<GestureFragment>unsafeCast(this));
    }
  }
