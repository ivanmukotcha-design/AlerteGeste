...
public abstract interface AlerteDao {
    ...
    @androidx.room.Query(value = "UPDATE sms_parts SET statut = :status, failureReason = :failureReason WHERE id = :id AND statut IN (\'EN_ATTENTE\', \'INCONNU\')")
    @org.jetbrains.annotations.Nullable()
