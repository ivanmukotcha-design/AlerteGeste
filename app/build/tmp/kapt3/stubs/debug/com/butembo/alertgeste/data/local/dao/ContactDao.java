...
public abstract interface ContactDao {
    ...
    @androidx.room.Query(value = "SELECT COUNT(*) FROM contacts WHERE telephone = :phone AND id != :exceptId")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object countPhone(@org.jetbrains.annotations.NotNull()
    java.lang.String phone, long exceptId, @org.jetbrains.annotations.NotNull()
